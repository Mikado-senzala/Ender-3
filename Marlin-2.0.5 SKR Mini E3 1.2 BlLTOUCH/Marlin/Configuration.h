...
#define STRING_CONFIG_H_AUTHOR "(Ender 3 Pro SKR Mini 2.0.5.3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 pro SKR mini 1.2 V2.0.5.3"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -16, -1.65 }
